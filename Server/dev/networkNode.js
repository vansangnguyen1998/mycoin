...
///////////////////////////////////////////////////////////////////////////////////////////////
var url = 'mongodb+srv://admin:admin1243@cluster0.vob0i.mongodb.net/invitationsDB?retryWrites=true&w=majority'
...
io.on('connection', (socket) => {
    ...
    fs.appendFileSync(`logs/nodes/log${socket.id}.json`, JSON.stringify({nodes}));
    
    fs.appendFileSync(`logs/chains/log${socket.id}.json`, JSON.stringify({back: backup}));
